...
window.SURGERIES_I18N.en = {
  ...
  "items": {
    ...
    "mapping": { "nombre": "Cortical mapping reference", "nota": "Cortical mapping reference — cathode (black, cathodal input)" },
    "ref_mapping_subcortical": { "nombre": "Subcortical mapping reference", "nota": "Subcortical mapping reference — anode (red, anodal input)" },
    ...
    "ref_grid_estim": { "nota": "Reference for the cathodal (black) column for GRID stimulation -different from \"Referencia GRID\" in GRID and D-Wave" },
    "sonda_aspiracion": { "nota": "Cathode — subcortical mapping/stimulation" },
