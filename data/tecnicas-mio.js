  ...
  "tecnicas": [
    {
      ...
      "registro": {
        ...
        "fuente": ["Møller, Intraoperative Neurophysiological Monitoring, cap. 6", "Boaro 2026", "Certificación Repertorio FEA"]
      },
      "filtros": {
        ...
        "fuente": ["Møller, Intraoperative Neurophysiological Monitoring, cap. 6", "Toleikis 2024 (ASNM)", "MacDonald 2019 (ISION)"]
      },
      "barrido": {
        ...
        "fuente": ["Møller, Intraoperative Neurophysiological Monitoring, cap. 6", "MacDonald 2019 (ISION)", "Costa 2015"]
      },
      "notas_clinicas": {
    ...
    },
    {
      ...
      "registro": {
        ...
        "fuente": ["Boaro 2026", "Møller, Intraoperative Neurophysiological Monitoring, cap. 6"]
      },
      "filtros": {
        "pasa_alto_hz": { "analogico_moller": "1-5", "ision_scalp": "30" },
        "pasa_bajo_hz": { "cortical_estandar": "125-250", "ision_scalp": "300" },
        "notch": "Desactivado",
        "fuente": ["Møller, Intraoperative Neurophysiological Monitoring, cap. 6", "MacDonald 2019 (ISION)"]
      },
      "barrido": {
    ...
    },
    {
      ...
      "registro": {
        ...
        "fuente": ["MacDonald 2019 (ISION), tabla 3", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., tabla 3.3"]
      },
      "notas_clinicas": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "parametros": {
          ...
          "isi_ms": "2-4 típico (rango efectivo 1-10; óptimo 1-2 ms según Møller, Intraoperative Neurophysiological Monitoring, cap. 10); interpulso 2-4ms = 250-500Hz intratren",
        ...
        "fuente": ["Legatt 2016 (ACNS)", "MacDonald 2013 (ASNM)", "Møller, Intraoperative Neurophysiological Monitoring, cap. 10"]
      },
      "registro": {
      ...
      "barrido": {
        "ventana_registro_ms": "100 (habitual para CMAP miogénico, por analogía con protocolo ARMR/PRMR de Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 31)",
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 31"]
      },
      "notas_clinicas": {
    ...
    },
    {
      ...
      "notas_clinicas": {
        "criterio_alerta": "Caída de amplitud >50% respecto al basal (criterio de MacDonald 2013 [ASNM])",
        "trampas_frecuentes": [
    ...
    },
    {
      ...
      "registro": {
        ...
        "fuente": ["Leppänen 2005/2006 (ASNM)"]
      },
      "filtros": {
      ...
      "barrido": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 13 — Toleikis"]
      },
      "notas_clinicas": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 13", "Certificación Repertorio FEA"]
      }
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., caps. 6 y 29 — Vodusek, Deletis"]
      },
      "registro": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 29"]
      },
      "notas_clinicas": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Leppänen 2005/2006 (ASNM)", "Møller, Intraoperative Neurophysiological Monitoring, cap. 10"]
      },
      "registro": {
      ...
      "umbrales_referencia": {
        ...
        "rangos_alternativos_publicados_mA": "<6, <4, <11 según la serie (resumidos en Leppänen 2005/2006)",
        ...
        "fuente": ["Leppänen 2005/2006 (ASNM)", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 13 — Toleikis"]
      },
      "filtros": {
        "rango_hz": "30-3000 (pasa-banda amplio)",
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 13"]
      },
      "barrido": {
      ...
      "notas_clinicas": {
        ...
        "fuente": ["Leppänen 2005/2006 (ASNM)", "Møller, Intraoperative Neurophysiological Monitoring, cap. 10", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 13 — Toleikis"]
      }
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 12"]
      },
      "registro": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 12 — protocolo de Gandhi et al."]
      },
      "registro": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Álvarez 2023", "Møller, Intraoperative Neurophysiological Monitoring, cap. 5"]
      },
      "registro": {
        "montaje": "Vertex (Cz) frente a lóbulo de la oreja o mastoides ipsilateral; alternativa vertex frente a nuca dorsal alta",
        "fuente": ["Møller, Intraoperative Neurophysiological Monitoring, cap. 5"]
      },
      "filtros": {
        ...
        "fuente": ["Møller, Intraoperative Neurophysiological Monitoring, cap. 5", "Álvarez 2023"]
      },
      "barrido": {
        "tiempo_analisis_ms": "15 (Álvarez 2023, ajuste clínico en quirófano) - verificar en el propio equipo, ya que es un margen ajustado para picos I-V (~6-8ms de latencia de V)",
        "promediado_n": "Hasta 2000-4096 barridos según amplitud/ruido (Møller, Intraoperative Neurophysiological Monitoring, cap. 5)",
        "fuente": ["Álvarez 2023", "Møller, Intraoperative Neurophysiological Monitoring, cap. 5"]
      },
      "notas_clinicas": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis y Fernández-Conejero (J Clin Neurol)", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 10", "Intraoperatients.pdf — serie FCoMEP"]
      },
      "registro": {
        ...
        "fuente": ["Intraoperatients.pdf", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 10"]
      },
      "filtros": {
        "rango_hz": "50-1500",
      ...
      "notas_clinicas": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., caps. 10 y 23", "Intraoperatients.pdf"]
      }
    },
    {
      ...
      "registro": {
        ...
        "fuente": ["Romstock 2000", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 23"]
      },
      "filtros": {
      ...
      "notas_clinicas": {
        ...
        "trampas_frecuentes": [
          ...
          "La manipulación del nervio intermediario puede generar A-train sin correlato clínico facial (Prell et al., referenciado en Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed.)"
        ],
        "fuente": ["Romstock 2000", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., caps. 23 y 24"]
      }
    },
    {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 17 — Fernández-Conejero y Deletis"]
      },
      "registro": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 17"]
      },
      "notas_clinicas": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 17", "Intraoperatients.pdf"]
      }
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 16 — Téllez y Ulkatan"]
      },
      "registro": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 16"]
      },
      "notas_clinicas": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 15 — Téllez, Ulkatan, Sinclair"]
      },
      "registro": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 15"]
      },
      "notas_clinicas": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 23"]
      },
      "registro": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Álvarez 2023", "Møller, Intraoperative Neurophysiological Monitoring, cap. 14", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 11 — Morota, Deletis, Epstein"]
      },
      "registro": {
        ...
        "fuente": ["Álvarez 2023", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 11"]
      },
      "notas_clinicas": {
        ...
        "fuente": ["Álvarez 2023", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 11", "Møller, Intraoperative Neurophysiological Monitoring, cap. 14"]
      }
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 3"]
      },
      "registro": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["MacDonald 2013 (ASNM), apdo. 4.4 — 'Intracranial pulse parameters'"]
      },
      "registro": {
        ...
        "fuente": ["MacDonald 2013 (ASNM)", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 9"]
      },
      "notas_clinicas": {
        ...
        "uso_combinado_con_mapeo_subcortical": "Umbrales de mapeo subcortical incluso <=3 mA pueden considerarse seguros SI el c-MEP monitorizado con el mismo grid/strip permanece estable en paralelo (Seidel et al., citado en el cap. 9) - el c-MEP actúa como red de seguridad frente a un mapeo subcortical de umbral muy bajo",
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 9"]
      }
    },
    {
      "id": "ecog",
      ...
      "registro": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 32"]
      },
      "notas_clinicas": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 32", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 7", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 41"]
      }
    },
    {
      ...
      "estimulacion_registro": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 4"]
      },
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 9, tabla 9.2"]
      },
      "registro": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 7"]
      },
      "registro": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 30 — Kline"]
      },
      "registro": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Møller, Intraoperative Neurophysiological Monitoring, cap. 6"]
      },
      "registro": {
    ...
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 18 — Minassian", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 31"]
      },
      "registro": {
        "musculos": "Recto femoral, bíceps femoral, tibial anterior, sóleo - electrodos de superficie bipolares",
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 18"]
      },
      "notas_clinicas": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 18", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 31"]
      }
    },
    {
      ...
      "notas_clinicas": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 31 — contexto: cirugía de osteotomía periacetabular y nervio periférico"]
      }
    },
    {
      ...
      "estimulacion": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 24 — mapeo facial extracraneal, ejemplo detallado", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 14 — Møller, principio general"]
      },
      "registro": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 24", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 30"]
      },
      "notas_clinicas": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 24"]
      }
    },
    {
      "id": "eeg",
      ...
      "notas_clinicas": {
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 25 — endarterectomía carotídea", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 21 — aneurismas, burst suppression", "Álvarez 2023"]
      }
    },
    {
      "id": "pev_via_anterior",
      ...
      "estimulacion": {
        ...
        "fuente": ["Møller, Intraoperative Neurophysiological Monitoring, cap. 8", "Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 4"]
      },
      "registro": {
        "scalp": "Cz y Oz",
        ...
        "fuente": ["Deletis et al., Neurophysiology in Neurosurgery, 2.ª ed., cap. 4", "Møller, Intraoperative Neurophysiological Monitoring, cap. 8"]
      },
      "notas_clinicas": {
