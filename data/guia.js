...
window.GUIA = {
  ...
  acordeon: [
    ...
    },
    {
      ...
      html: "<p>Dentro de la ficha de un caso, apartado <b>5. Montaje / Técnicas</b>, botón <b>Cargar plantilla…</b>. El mismo botón está también en la barra fija de arriba mientras corriges el material de un caso.</p><p>Elige una plantilla y <b>siempre</b> te pregunta antes de tocar nada -también con el caso vacío-, diciendo en números qué va a pasar: cuántas entradas se sobrescriben, o cuántas vacías se rellenan y cuántas se conservan. Puedes <b>Reemplazar todo</b> o <b>Añadir solo lo que falta</b> -esta segunda opción no toca ninguna entrada que ya tuviera material-.</p><p>Es una copia: aplicar la plantilla no crea ningún enlace con ella. Si el caso está cerrado o cancelado, pide una confirmación aparte antes de seguir.</p>"
    },
    {
