...
window.GUIA = {
  ...
  acordeon: [
    ...
    },
    {
      ...
      html: "<p>Desde <b>Gestión de casos</b>, la ficha se organiza en 8 apartados plegables, todos cerrados por defecto -se abre el que interese, no hace falta rellenar de arriba abajo-: Identificación/Trazabilidad, Paciente, Cirugía, Anestesia, Montaje/Técnicas, Desarrollo intraoperatorio, Resultado/Correlación clínica, y Docencia/Meta.</p><p>El <b>Estado</b> (apartado 1) puede ser Preparado, Cerrado o Cancelado. Un caso cancelado pide un motivo, y en el Google Sheet solo cuenta para trazabilidad y paciente -no entra en las estadísticas de técnicas ni de material, porque no llegó a monitorizarse de verdad-.</p><p>El apartado 5 (Montaje/Técnicas) se reparte en tres sub-apartados: <b>Cajas y entradas</b> -con el <b>detalle canal a canal</b>, qué hay puesto en cada entrada de cada caja con el mismo aspecto que la ventana Resumen, de solo lectura: para corregirlo hace falta el botón <b>Editar montaje</b>, que te lleva al Organizador de Montajes-, <b>Material</b> -el material real del caso, sin copia editable aparte: si añades algo que no estaba previsto, colócalo en su caja y anótalo en Notas del material; justo debajo sale también el <b>coste del material</b>, mismo desglose que en Resumen con los precios de hoy, tanto en pantalla como en el informe en PDF- y <b>Técnicas</b> -técnicas realizadas y cómo se realizó cada una, con sus propios campos por técnica-.</p>"
    },
    {
